🛡️ TripShield — Smart Tourist Safety Monitoring & Incident Response System

🏆 Secured Top 15 (Rank 14) at MNIT Projectathon 2025
👥 Team TripShield (EVX129) — JECRC Jaipur

🌍 Overview

TripShield is an intelligent safety monitoring and incident response system designed to make tourism safer and smarter.
It integrates AI, Geo-Fencing, and Blockchain-based Digital ID to ensure 24/7 protection for tourists and enable seamless coordination with law enforcement during emergencies.
...
💡 Vision
TripShield aims to build trust, safety, and confidence in travel by empowering both tourists and authorities with real-time, data-driven safety intelligence.
...
🔗 Project Links
💻 GitHub Repository: https://github.com/kishanomkar/tempproject
🏫 Event: MNIT Projectathon 2025
🌐 Live Demo: (Coming Soon)

⭐ If you like this project, give it a star on GitHub!
        
  Made with 💙 by Team TripShield

🗺️ Geo-Fencing — Safe zone monitoring for enhanced tourist safety
