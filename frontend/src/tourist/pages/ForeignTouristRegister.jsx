                    ...
                    <form onSubmit={handleSubmit} className="p-8 space-y-8">
                        ...
                        <div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <input type="text" name="originCountry" placeholder="Origin Country" required className="w-full px-4 py-2 border border-slate-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500" value={formData.originCountry} onChange={handleChange} />
                                <input type="text" name="destination" placeholder="Destination in Country" required className="w-full px-4 py-2 border border-slate-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500" value={formData.destination} onChange={handleChange} />
                            </div>
                        </div>
