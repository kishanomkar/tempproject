...
export default function DomesticTouristRegister() {
    ...
    // State to hold all form data, tailored for the domestic user schema
    const [formData, setFormData] = useState({
        fullname: '',
        gender: '',
        date_of_birth: '',
        nationality: 'Indian', // Pre-filled for domestic users
        aadharNumber: '',
        ...
        password: '',
        confirmPassword: '',
        smartTouristId: `ST-DOM-${Date.now()}` // Pre-filled example for domestic
    });
            ...
            <div className="container mx-auto px-4 py-12">
                <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-lg overflow-hidden">
                    <div className="p-8 bg-slate-800 text-white">
                        <h1 className="text-3xl font-bold">Domestic Tourist Registration</h1>
                        ...
                        <div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <input type="text" id="nationality" name="nationality" readOnly className="w-full px-4 py-2 border border-slate-300 rounded-md bg-slate-100 text-slate-500" value={formData.nationality} />
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                 ...
                                 <div>
                                    <label htmlFor="departureDate" className="block text-sm font-medium text-slate-600 mb-1">Departure Date (Optional)</label>
                                    <input type="date" id="departureDate" name="departureDate" className="w-full px-4 py-2 border border-slate-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500" value={formData.departureDate} onChange={handleChange} />
                                </div>
                                <div className="md:col-span-2">
                                    <label htmlFor="destination" className="block text-sm font-medium text-slate-600 mb-1">Destination</label>
                                    <input type="text" id="destination" name="destination" placeholder="e.g., Jaipur, Rajasthan" required className="w-full px-4 py-2 border border-slate-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500" value={formData.destination} onChange={handleChange} />
                                </div>
                                <div className="md:col-span-2">
                                     <label htmlFor="flightNumber" className="block text-sm font-medium text-slate-600 mb-1">Flight/Train Number (Optional)</label>
                                    <input type="text" id="flightNumber" name="flightNumber" className="w-full px-4 py-2 border border-slate-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500" value={formData.flightNumber} onChange={handleChange} />
                                </div>
                            </div>
                        </div>
